...
const TABLES = {
  sessions: {
    ...
    columns: ['id', 'user_id', 'title', 'status', 'total_tokens', 'created_at'],
    expandableField: 'title',
    statusField: 'status',
    statusOptions: ['active', 'paused_approval', 'paused_hitl', 'completed', 'failed'],
  },
  approvals: {
    label: 'Approvals',
    fetch: getAdminApprovals,
    columns: ['id', 'approval_type', 'tool_name', 'status', 'required_role', 'created_at'],
  ...
  hitl_questions: {
    ...
    columns: ['id', 'agent_run_id', 'question', 'status', 'answer', 'created_at'],
    expandableField: 'question',
    statusField: 'status',
    statusOptions: ['pending', 'answered'],
  },
  builds: {
    label: 'Builds',
    fetch: getAdminBuilds,
    columns: ['id', 'project_id', 'branch', 'status', 'session_id', 'created_at'],
    expandableField: 'build_logs',
    statusField: 'status',
    statusOptions: ['pending', 'building', 'success', 'failed'],
  },
}
...
const STATUS_COLORS = {
  ...
  workflow_step: 'bg-purple-100 text-purple-700',
}
