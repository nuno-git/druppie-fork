...
import { Database, ChevronDown, Check, X, Link2, Loader2 } from 'lucide-react'
      ...
      {open && (
        <div className="absolute top-full mt-1 right-0 w-72 rounded-lg shadow-lg z-50 bg-white border border-gray-200">
          ...
          {sources.length === 0 && !isLoading && (
            <div className="px-3 py-4 text-xs text-gray-400 text-center">No data sources configured</div>
          )}
