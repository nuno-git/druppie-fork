...
class Session(Base):
    ...
    status = Column(String(30), default="active", index=True)  # active, paused, paused_approval, paused_hitl, paused_crashed, completed, failed, terminated
    ...
    fd_rejection_count = Column(Integer, default=0, server_default="0")
