...
from druppie.api.routes import agent_test, agents, approvals, cache, chat, datasources, deployments, documentation, escalations, evaluations, jobs, mcp_bridge, mcps, model_management, modules, notifications, projects, questions, sandbox, sessions, tool_output, users, workspace
...
def create_app() -> FastAPI:
    ...
    app.include_router(escalations.router, prefix="/api/sessions", tags=["Escalations"])
