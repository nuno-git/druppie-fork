...
from druppie.api.routes import agents, approvals, atk_agents, chat, deployments, mcp_bridge, mcps, projects, questions, sandbox, sessions, workspace
...
def create_app() -> FastAPI:
    ...
    app.include_router(atk_agents.router, prefix="/api", tags=["ATK Agents"])
