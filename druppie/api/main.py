...
from druppie.api.routes import agents, approvals, azure_auth, cache, chat, deployments, mcp_bridge, mcps, projects, questions, sandbox, sessions, workspace
...
def create_app() -> FastAPI:
    ...
    app.include_router(azure_auth.router, prefix="/api", tags=["Azure Auth"])
