...
class CodingModule:
    ...
    def _detect_test_framework(self, workspace_path: Path) -> tuple[str | None, str | None]:
    ...
    def _parse_test_output(self, stdout: str, stderr: str, framework: str) -> dict:
    ...
    async def run_tests(
        ...
        try:
            ...
            if command is None:
                framework, command = self._detect_test_framework(workspace_path)
                if command is None:
                    return {
                        "success": False,
                ...
                if "pytest" in command:
                    ...
                    framework, _ = self._detect_test_framework(workspace_path)
            ...
            try:
                ...
                parsed = self._parse_test_output(result.stdout, result.stderr, framework)
