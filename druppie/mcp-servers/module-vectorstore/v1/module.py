...
class VectorStoreModule:
    ...
    async def index_documents(
        ...
        # Char-based approximation of recursive 512-token chunks per the
        # 2026 RAG benchmarks (Vecta / Firecrawl / Digital Applied) cited
        # in docs/RAG/rag-patterns.md. tiktoken-precise token counting
        # is a Story-B-level upgrade.
        chunk_size: int = 2048,
