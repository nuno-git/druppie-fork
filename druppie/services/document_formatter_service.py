...
Also provides markdown -> Typst conversion so that agents never need
to author raw Typst -- they write markdown and the platform handles
the branded PDF pipeline.
"""
