...
class EscalationEventType(str, Enum):
    ...
    ARCHITECT_HITL_APPROVE = "architect_hitl_approve"
    ARCHITECT_HITL_REJECT_TO_BA = "architect_hitl_reject_to_ba"
    ARCHITECT_HITL_REJECT_TERMINATE = "architect_hitl_reject_terminate"
