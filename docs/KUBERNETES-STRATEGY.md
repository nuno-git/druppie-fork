...
> **Status: Historische spike (2026-06-02).** Vervangen door `docs/ADR-KUBERNETES.md` (beslissingen) en `docs/AS-BUILT-ARCHITECTURE.md` (huidige staat). Toekomstige richting: `docs/STORIES-KUBERNETES-VOLGENDE.md`. De Hetzner-specifieke provisioning/kosten secties zijn behouden ter referentie maar reflecteren niet langer het geplande lokale-Rancher doel.
