...
- **PR #277** (Nuno) — *built* a documentation framework: spec, 3 validator scripts, CAS generator, 7 agent skills, 3 real ADRs, templates, lefthook hooks, acceptance spec scaffolding, design-system docs. Ambitious but half-broken.
...
6. **Acceptance spec layer can't run** — features reference non-existent PRDs, steps have no definitions, implementations are tautological.
...
9. **Delete acceptance spec scaffolding** — features reference non-existent PRDs, steps have no definitions. Dead weight. Defer acceptance specs to a future phase.
...
- Nuno's acceptance spec features and step implementations (broken)
...
- [ ] No broken acceptance spec scaffolding in repo
